    ...
    <div style="padding: 0px 20px">
        ...
        <div class="gridlayoutsix">
            <div class="layoutsix">
                <table>
                    ...
                    <tr>
                        <td style="visibility:hidden">17 : 3 = 5,667</td>
                    </tr>
                </table>
            </div>
            <div class="layoutsix">
        ...
        <h3>Het toepassen van een zeef</h3>
        ...
        <br />We controleren 2047 nog een keer. In tabel 3 is na 21 delers bewezen dat 2047 geen priemgetal is. Door gebruik te maken van de zeef, blijven de volgende delers over: 3, 5, 7, 11, 13, 17, 19 en 23. Een verschil van dertien delers.</p>
